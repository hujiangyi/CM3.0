...
class cm30 :
    ...
    def finishTest(self,isFail = True):
        ...
        updataMsg["log"] = testLog
        updataMsg["isFail"] = "{}".format(isFail)
        if isFail :
            updataMsg["errorStep"] = "{}".format(self.step)
        else :
            updataMsg["errorStep"] = "{}".format(20)
        self.db.updataLog(self.sn.get(),updataMsg)
